...
function settings {
	...
	data modify storage perf_tool:ram test_a_name set value '{"text": "Scoreboard Tree"}'
	# The name of the second test. This is used to identify the test in the results.
	data modify storage perf_tool:ram test_b_name set value '{"text": "Macro Function Call"}'
}

...
execute store success score #success aj.i run function animated_java:armor_stand_merge/zzz/19 with storage aj:temp args
...
execute if data storage aj:temp {args:{start_animation: 1b}} run function animated_java:armor_stand_merge/zzz/22 with storage aj:temp args